...
{$ENDIF}
  ...
  SHL_MemoryManager, SHL_Knapsack;
...
type
 ...
 {$IFDEF SHL_GRAPHICS}
  ...
  {$IFDEF SHL_GZIP}
  NSavestateType = SHL_SavestateReader.NSavestateType;

  TSavestateReader = SHL_SavestateReader.TSavestateReader;
  {$ENDIF}
  ...
  TKnapsack = SHL_Knapsack.TKnapsack;
